...
-- ----------------------------
-- Table structure for u_college_user
-- ----------------------------
DROP TABLE IF EXISTS `u_college_user`;
CREATE TABLE `u_college_user`  (
...
-- ----------------------------
-- Records of u_college_user
-- ----------------------------
INSERT INTO `u_college_user` VALUES ('信息技术学院', '黄弋峰', 'XX000', 'XX00', '四川省绵阳市游仙区', 18781166142, 0, '2022-11-17 19:39:53');
